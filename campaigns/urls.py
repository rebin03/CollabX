...
urlpatterns = [
    ...
    path('campaign/complete/<int:pk>/', views.CompleteCampaignView.as_view(), name='complete-campaign'),
    ...
    path('report/submit/<int:pk>/', views.SubmitReportView.as_view(), name='submit-report'),
    path('report/review/<int:pk>/', views.ReviewReportView.as_view(), name='review-report'),
    path('report/view/<int:pk>/', views.ViewReportView.as_view(), name='view-report'),
